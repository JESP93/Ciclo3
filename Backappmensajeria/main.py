...
@app.route("/")
def index():
    return render_template("auth2/login.html")
...
def login():
     if request.method == 'POST':
        ...
        if len(response)==0:
            ...
            return render_template("auth2/principal.html",datas=response2)
...
def enviarMAIL():
    if request.method == 'POST':
        ...
        enviomail.enviar(destino,mensaje2,"Nuevo mensaje recibido")
...
def historialenviados():
    ...
    return render_template("auth2/respuesta.html",datas=resultado)
